...
import {
  Search, MapPin, Briefcase, Sparkles, Zap,
  Shield, TrendingUp, ArrowRight, ChevronRight, Users,
} from "lucide-react";

const TRENDING_SKILLS = [
  "React.js", "Node.js", "Python", "Data Science",
  "UI/UX Design", "DevOps", "Machine Learning", "AWS",
];
...
const TOP_COMPANIES = [
  ...
  "Infosys", "TCS", "Wipro", "Zomato", "Swiggy", "Razorpay",
];

const FEATURES = [
  {
    icon: <Sparkles size={22} />, bg: "bg-violet-50", text: "text-violet-600",
    title: "AI-Powered Matching",
    desc: "Our AI scores your profile against every job and shows you exactly why you're a fit.",
  },
  {
    icon: <Zap size={22} />, bg: "bg-blue-50", text: "text-blue-600",
    title: "One-Click Apply",
    desc: "Apply to any job in seconds using your saved profile. No re-entering details ever again.",
  },
  {
    icon: <Shield size={22} />, bg: "bg-green-50", text: "text-green-600",
    title: "Verified Companies",
    desc: "Every employer is manually verified. No fake job postings, guaranteed.",
  },
];
    ...
    <div className="min-h-screen bg-slate-50 pt-16">
      ...
      <section className="bg-gradient-to-br from-blue-700 via-blue-600 to-blue-800 text-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* AI badge */}
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm border border-white/25 rounded-full px-4 py-1.5 text-sm mb-6">
            <Sparkles size={13} className="text-yellow-300" />
            Now with AI-powered resume analysis &amp; job matching
          </div>
      ...
      {/* ── AI Banner (logged-in students only) ───────────────────────── */}
          ...
          <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-violet-200 text-xs">Resume analyzer · Cover letter generator · Interview prep · Salary predictor</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
          {CATEGORIES.map(({ icon, label, count }) => (
            <Link key={label}
              ...
              className="bg-white border border-gray-200 rounded-xl p-4 text-center hover:border-blue-300 hover:shadow-card-hover transition-all group">
      ...
      <section className="bg-white border-y border-gray-200 py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl font-bold text-gray-900 text-center mb-8">
            Why job seekers love JobPortal
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {FEATURES.map(({ icon, bg, text, title, desc }) => (
              <div key={title}
                className="flex gap-4 p-5 rounded-2xl border border-gray-100 hover:shadow-card transition-all">
                <div className={`w-12 h-12 ${bg} ${text} rounded-xl flex items-center justify-center shrink-0`}>
                  {icon}
                </div>
                <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {TOP_COMPANIES.map((company) => (
            <Link key={company}
              to={`/jobs?search=${encodeURIComponent(company)}`}
        ...
        <section className="bg-blue-600 text-white py-14 px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link to="/register"
                className="border border-white/40 text-white font-medium px-8 py-3.5 rounded-xl hover:bg-white/10 transition-colors text-sm">
      ...
      <footer className="bg-white border-t border-gray-200 py-8 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-6 text-xs text-gray-400">
            ...
            <Link to="/register" className="hover:text-blue-600">For Employers</Link>
          </div>
