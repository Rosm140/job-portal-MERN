    ...
    const init = async () => { 
      ...
      if(t){ 
        try { 
          ...
          const userData = r.data?.data?.user || r.data?.user;
          dispatch({type:"LOGIN_SUCCESS",payload:{user: userData, token:t}}); 
          localStorage.setItem("user",JSON.stringify(userData)); 
        } catch { 
          localStorage.removeItem("token"); localStorage.removeItem("user"); dispatch({type:"LOGOUT"}); 
        } 
      } 
